...
appControllers.controller('addPropCtrl', function ($scope,$stateParams, $timeout, NoteDB, $state) {
...
appControllers.controller('noteDetailCtrl', function ($scope, NoteDB, $stateParams, $filter, $mdBottomSheet, $mdDialog, $mdToast, $ionicHistory) {
     ...
     $scope.createProperty = function(prop, isValid) {
        ...
        var address = $scope.prop.address;
        console.log(address);
    ...
    $scope.initialForm = function () {
        ...
        $scope.items = ['Apartment', 'Condo', 'House', 'Townhouse'];
        $scope.selectedItem;
